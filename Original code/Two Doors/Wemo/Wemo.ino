...
const char* ssid = "Modem 56K";
const char* password = "enfinduwifi";
...
void setup()
{
  ...
  if(wifiConnected){
    ...
    office = new Switch("Jean lights", 80, officeLightsOn, officeLightsOff);
    kitchen = new Switch("Jeannette lights", 81, kitchenLightsOn, kitchenLightsOff);
